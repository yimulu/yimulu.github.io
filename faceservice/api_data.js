define({ "api": [
  ...
  },
  {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "Json",
            "optional": false,
            "field": "faceInfoComparisons.targetInfo",
            "description": "<p>Target face info.</p>"
          },
          {
            "group": "Success 200",
            "type": "Float",
            "optional": false,
            "field": "faceInfoComparisons.targetInfo.confidence",
          ...
          },
          {
            ...
            "type": "List",
            "optional": false,
            "field": "faceInfoComparisons.sourceMatches",
            "description": "<p>Matched source faces.</p>"
          },
          {
            "group": "Success 200",
            "type": "Float",
          ...
          },
          {
            ...
            "type": "List",
            "optional": false,
            "field": "faceInfoComparisons.sourceMatches.boundingBox",
            "description": "<p>Bounding box of face was detected, [x, y, w, h].</p>"
          },
          {
            "group": "Success 200",
    ...
    "filename": "faceapidoc/_comparison_0.1.0.js",
  ...
  },
  {
    ...
    "filename": "faceapidoc/_detection_0.1.0.js",
  ...
  },
  {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "Float",
            "optional": false,
            "field": "faceComparisons.faceInfo.confidence",
            "description": "<p>confidence of face was detect.</p>"
          },
          {
            "group": "Success 200",
          ...
          },
          {
            ...
            "type": "Float",
            "optional": false,
            "field": "faceComparisons.faceMatches.similarity",
            "description": "<p>The similarity score.</p>"
          }
        ]
      },
    ...
    "filename": "faceapidoc/_recognition_0.1.0.js",
    "groupTitle": "Recognition"
  },
  {
    "type": "post",
  ...
  },
  {
    ...
    "filename": "faceapidoc/_stream_0.1.0.js",
    "groupTitle": "Stream"
  },
  {
    "type": "post",
